...
// Shown after email verification. Saves target_role, experience_level,
// industry to the users table, then redirects to dashboard.
    ...
    <div style={styles.page}>
      <div style={styles.card}>
        ...
        <div style={{ marginBottom: '1.75rem', textAlign: 'center' }}>
          ...
          <p style={styles.sub}>Tell us what role you're targeting so we can personalise your questions.</p>
        </div>
        ...
        <form onSubmit={handleSave} style={{ display: 'flex', flexDirection: 'column', gap: '1.25rem' }}>
              ...
              {ROLES.map(role => (
                <button
                  ...
                  style={{
                    ...
                    border: targetRole === role
                      ? '1px solid var(--color-cz-burg)'
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '0.4rem' }}>
              {EXPERIENCE_LEVELS.map(({ value, label }) => (
                <label key={value} style={{
                  ...
                  borderRadius: 8,
                  border: experienceLevel === value
                    ? '1px solid var(--color-cz-burg)'
                    : '1px solid var(--color-cz-border)',
                  background: experienceLevel === value
          ...
          <div>
            <label style={styles.label}>
              Bio <span style={{ fontWeight: 400, color: 'var(--color-cz-muted)' }}>(optional)</span>
            </label>
            <textarea
              placeholder="A short intro — helps the AI tailor questions to your background"
              value={bio}
